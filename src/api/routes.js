...
function createAPIRouter(storage) {
  ...
  router.get('/sessions/:id/captures', (req, res) => {
    ...
    res.json(captures.map(c => ({
      ...
      breakdown: c.breakdown ? {
        ...
        system_prompts: { tokens: c.breakdown.system_prompts.tokens, percentage: c.breakdown.system_prompts.percentage },
        tool_definitions: { tokens: c.breakdown.tool_definitions.tokens, percentage: c.breakdown.tool_definitions.percentage, count: c.breakdown.tool_definitions.count },
        tool_calls: { tokens: c.breakdown.tool_calls.tokens, percentage: c.breakdown.tool_calls.percentage, count: c.breakdown.tool_calls.count },
        tool_results: { tokens: c.breakdown.tool_results.tokens, percentage: c.breakdown.tool_results.percentage, count: c.breakdown.tool_results.count },
        assistant_text: { tokens: c.breakdown.assistant_text.tokens, percentage: c.breakdown.assistant_text.percentage },
        user_text: { tokens: c.breakdown.user_text.tokens, percentage: c.breakdown.user_text.percentage, messageCount: c.breakdown.user_text.messageCount },
        thinking_blocks: { tokens: c.breakdown.thinking_blocks.tokens, percentage: c.breakdown.thinking_blocks.percentage },
        media: { tokens: c.breakdown.media.tokens, percentage: c.breakdown.media.percentage, count: c.breakdown.media.count },
  ...
  router.get('/sessions/:id/composition', (req, res) => {
    ...
    res.json({
      composition: {
        categories: [
          { name: 'System Prompts', key: 'system_prompts', tokens: b.system_prompts.tokens, percentage: b.system_prompts.percentage, color: '#6366f1' },
          { name: 'Tool Definitions', key: 'tool_definitions', tokens: b.tool_definitions.tokens, percentage: b.tool_definitions.percentage, color: '#f59e0b' },
          { name: 'Tool Calls', key: 'tool_calls', tokens: b.tool_calls.tokens, percentage: b.tool_calls.percentage, color: '#ef4444' },
          { name: 'Tool Results', key: 'tool_results', tokens: b.tool_results.tokens, percentage: b.tool_results.percentage, color: '#10b981' },
          { name: 'Assistant Text', key: 'assistant_text', tokens: b.assistant_text.tokens, percentage: b.assistant_text.percentage, color: '#f97316' },
          { name: 'User Text', key: 'user_text', tokens: b.user_text.tokens, percentage: b.user_text.percentage, color: '#06b6d4' },
          { name: 'Thinking', key: 'thinking_blocks', tokens: b.thinking_blocks.tokens, percentage: b.thinking_blocks.percentage, color: '#a855f7' },
          { name: 'Media', key: 'media', tokens: b.media.tokens, percentage: b.media.percentage, color: '#ec4899' },
        ],
